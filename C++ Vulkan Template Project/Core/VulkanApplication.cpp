...
void VulkanApplication::initVulkan() {
    ...
    // Create Mesh using Mesh helper class
    mesh = std::make_unique<Mesh>(device, physicalDevice, commandPool, graphicsQueue);
...
// note: legacy createVertexBuffer/createIndexBuffer kept for compatibility but Mesh is used now
