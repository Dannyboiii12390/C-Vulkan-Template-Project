...
Engine::Mesh ModelLoader::loadCube(VulkanContext& context) {
...
Engine::Mesh ModelLoader::createGrid(VulkanContext& context, int width, int depth)
{
    std::vector<Engine::Vertex> vertices;
    std::vector<uint16_t> indices;
...
Engine::Mesh ModelLoader::createTerrain(VulkanContext& context, int width, int depth, float cellSize)
{
    std::vector<Engine::Vertex> vertices;
    std::vector<uint16_t> indices;
...
Engine::Mesh ModelLoader::createCylinder(VulkanContext& context, float radius, float height, int segmentCount)
{
    std::vector<Engine::Vertex> vertices;
    std::vector<uint16_t> indices;
...
Engine::Mesh ModelLoader::loadObj(VulkanContext& context, const char* filepath)
{
    //load the model 
